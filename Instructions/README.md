...
Use SQLAlchemy to model your table schemas and create a sqlite database for your tables. You will need one table per weather station. Use the station name as the table name.
